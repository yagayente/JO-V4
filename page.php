  ...
  <div class="rendu" id="pageinfos">
    ...
    <div class="bloc_droite" style="background-color: <?php the_field( 'couleur_arriere_cadre', 'option' ); ?>">
      <div class="marges_image">
				...
				<picture class="back">
					<img id="one" <?php responsive_image(get_field( 'image_presentation', 'option' ),'large','2500px'); ?> />
          <img id="two" <?php responsive_image(get_field( 'image_presentation_copie', 'option' ),'large','2500px'); ?> />
				</picture>
      </div>
