...
var tns = function(options) {
  ...
  function initTools () {
    ...
    // == live region ==
    outerWrapper.insertAdjacentHTML('beforeend', '<div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true"><span class="current">' + getLiveRegionStr() + '</span>&#8239;/&#8239;' + slideCount + '</div>');
